...
import com.example.a2aserver.sdk.server.DefaultProtocolServerFactory;
...
public class A2AServerAutoConfiguration {
     ...
     */
    @Bean
    public ProtocolServerFactory protocolServerFactory(
            A2AServerProperties properties,
            ApplicationContext context) {
        return new DefaultProtocolServerFactory(properties, context);
    }
