...
import com.example.a2aserver.sdk.model.SendTaskStreamingResponse;
import com.example.a2aserver.sdk.model.TaskSendParams;
import com.example.a2aserver.sdk.model.XA2AError;
...
public class A2AClient {
                ...
                for (String line : lines) {
                    ...
                    try {
                        ...
                        if (streamingResponse.error() != null) {
                            XA2AError  error = streamingResponse.error();
    ...
    private JSONRPCResponse doRequest(JSONRPCRequest request) throws A2AClientException {
        try {
            ...
            if (error != null) {
                throw new A2AClientException(error.getMessage(), error.getCode());
            }
